...
const FeesFormNew = ({ title }) => {
    ...
    const handleAmounttypeSelectChange = (selectedOption) => {
        setInputValues({
          ...inputValues,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://127.0.0.1:5000/student/add_feesform", {
                method: "POST",
        ...
        <>
         ...
         <>
                                         ...
                                         {  input.fieldName === "amount_type" ? (
                                                ...
                                                onChange={handleAmounttypeSelectChange}
                                                required
                                                />
                                            ) :(
                                         <input
