...
const StudentrecordNew = ({ title }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://127.0.0.1:5000/add_srecord", {
                method: "POST",
            ...
            setInputValues({});
            showNotification("Student Record has been added successfully!");
        } catch (error) {
          console.log(error);
        }
    };
                            ...
                            <div className="right">
                                <form onSubmit={handleSubmit}>
                                    <div className="formInput">
                                        <label htmlFor="file">
                                            Report Card: <DriveFolderUploadOutlinedIcon className="icon" />
                                        </label>
                                        <input
                                            type="file"
                                            id="file"
...
export default StudentrecordNew;
